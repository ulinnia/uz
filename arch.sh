...
echo -e "\n\n\n" | sudo pacman -Syu alsa-utils pulseaudio-alsa xf86-video-vesa xorg xorg-xinit xf86-input-libinput noto-fonts-cjk ttf-ubuntu-font-family fcitx-im fcitx-rime fcitx-config rxvt-unicode i3 yay feh dmenu networkmanager blueman curl firefox git gvim libreoffice-zh-CN p7zip ranger tree vlc wget zsh
